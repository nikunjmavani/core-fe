...
| **Preview** (`.github/workflows/preview.yml`)                              | PR to `main`                          | Build and upload `dist/` artifact (retention 7 days).                                                                                                                                                                                                                                                                                                             |
...
- PR CI (`pr-ci.yml`) and Preview (`preview.yml`) run on PRs to `main`.

...
| `/organization/$organizationSlug`           | Org-scoped shell — guard chain (auth → membership → status) syncs context from the URL; renders AppLayout                                    | memberships + permissions                                                                                     |
...
| `#settings/organization/…`                  | `general` · `members` · `roles` · `branches` · `integrations` — needs organization context + section permission                              | org endpoints per section                                                                                     |
| **System**                                  |                                                                                                                                              |                                                                                                               |
| `/*` (no match)                             | 404                                                                                                                                          | —                                                                                                             |

...
| `ts-pattern`                       | No              | Installed but currently unused — adopt or remove.                                                                                                                                      |
...
| `zustand`                          | Yes             | useAuthStore, useThemeStore (with persist), useUIStore, useTenantStore; create + getState.                                                                                             |
| **DevDependencies**                |                 |                                                                                                                                                                                        |

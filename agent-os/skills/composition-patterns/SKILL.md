...
From [vercel-labs/agent-skills](https://github.com/vercel-labs/agent-skills). Install via: `npx ctx7 skills install /vercel-labs/agent-skills composition-patterns --cursor`

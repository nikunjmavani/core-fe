...
- Writing new React components or pages in this Vite SPA
- Implementing data fetching (TanStack Query, route loaders)
...
From [vercel-labs/agent-skills](https://github.com/vercel-labs/agent-skills). Install via: `npx ctx7 skills install /vercel-labs/agent-skills react-best-practices --cursor`

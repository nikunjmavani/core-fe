...
Pure redirect route — no island UI. Order: last-used org dashboard → `/organization` picker → `/onboarding`.
Personal org uses root `/dashboard`; team org uses `/organization/$organizationSlug/dashboard`.

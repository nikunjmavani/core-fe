...
- **emil-design-eng** — When/why motion (craft bar); read before adding animation
- **review-animations** — PR review of motion code only
- **frontend-design** — Visual craft within React/shadcn guardrails

**Anime.js in core-fe:** Use for object tweens and timelines (e.g. `useAnimeCountUp`). Do not add Framer Motion — removed to avoid conflicting motion stacks.
